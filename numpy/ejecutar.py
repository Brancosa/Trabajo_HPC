...
valores_infectados = [150, 225, 337, 506, 759, 1139, 1708, 2562, 3844, 2562, 3844]
repeticiones = 4
...
for infected in valores_infectados:
    ...
    for i in range(repeticiones):
        ...
        resultado = subprocess.run(["python", "epidemianumpy2.py", str(infected)], capture_output=True, text=True)
