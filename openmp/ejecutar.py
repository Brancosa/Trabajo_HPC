...
valores_infectados = [10000000,20000000,30000000,40000000,50000000]
repeticiones = 4
...
for infected in valores_infectados:
    ...
    for i in range(repeticiones):
        ...
        resultado = subprocess.run(["python", "epidemiaomp.py", str(infected)], capture_output=True, text=True)
